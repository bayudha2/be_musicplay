...
describe('UserRepositoryPostgres', () => {
  ...
  describe('behavior test', () => {
    ...
    describe('updateUserProfil', () => {
      it('should update user with profil image correctly', async () => {
        // Arrange
        const userRepositoryPostgres = new UserRepositoryPostgres(pool, {});
        await UsersTableTestHelper.addUser({
          id: 'user-123',
        ...
        const payload = {
          id: 'user-123',
          filename: '1123423flower.jpeg',
        };

        // Action
        const result = await userRepositoryPostgres.updateUserProfil(payload);
    ...
    describe('updateUserBackground', () => {
      it('should update user with background image correctly', async () => {
        // Arrange
        const userRepositoryPostgres = new UserRepositoryPostgres(pool, {});
        await UsersTableTestHelper.addUser({
          id: 'user-123',
        ...
        // Action
        const result = await userRepositoryPostgres.updateUserBg(payload);
